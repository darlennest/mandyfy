...
import { Home, Search, Library, Plus, Heart, Play, Pause, SkipBack, SkipForward, Volume2, Shuffle, Repeat, ChevronLeft, ChevronRight, X, Clock, MoreHorizontal } from 'lucide-react'
        ...
        <div className="flex flex-1 overflow-hidden">
            ...
            <div className="bg-gradient-to-b from-[#5038a0] to-[#121212] pb-8">
              <div className="p-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <Heart className="w-8 h-8 text-[#1ed760]" />
                </div>
              </div>
            </div>
          ...
          <div className="w-[320px] bg-[#121212] border-l border-[#282828] p-4 shrink-0">
            ...
            <div className="flex items-center justify-between">
              ...
              <Heart className="w-5 h-5 text-[#1ed760] fill-[#1ed760]" />
            </div>
          </div>
        </div>
        ...
        <div className="h-[90px] bg-black border-t border-[#282828] px-4 flex items-center justify-between shrink-0">
          ...
          <div className="flex flex-col items-center gap-2 w-[40%]">
            ...
            <div className="flex items-center gap-2 w-full">
              <span className="text-[#b3b3b3] text-xs w-10 text-right">0:00</span>
              <div className="flex-1 h-1 bg-[#4d4d4d] rounded-full"><div className="h-full bg-white rounded-full w-0"></div></div>
              <span className="text-[#b3b3b3] text-xs w-10">4:23</span>
            </div>
          </div>
          <div className="flex items-center justify-end gap-3 w-[30%]">
            <Volume2 className="w-4 h-4 text-[#b3b3b3]" />
            <div className="w-24 h-1 bg-[#4d4d4d] rounded-full"><div className="h-full bg-white rounded-full w-[70%]"></div></div>
          </div>
        </div>
      </div>
    )
    ...
    <div className="h-screen bg-[#121212] flex flex-col overflow-hidden">
        ...
        <div className="w-[280px] bg-black flex flex-col p-2 gap-2 shrink-0">
          ...
          <div className="bg-[#121212] rounded-lg p-4 flex-1 overflow-hidden flex flex-col">
            <div className="flex items-center justify-between mb-4">
              ...
              <Plus className="w-5 h-5 text-[#b3b3b3] hover:text-white cursor-pointer transition-colors" />
            </div>
          ...
          <div className="bg-gradient-to-b from-[#1a1a1a] to-[#121212] min-h-full">
            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                ...
                >
                  <div className="bg-gradient-to-r from-[#1ed760] via-[#ff6b6b] to-[#4ecdc4] p-8 relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-600/30 via-pink-500/30 to-orange-400/30 animate-pulse"></div>
                    <div className="relative z-10 flex items-center justify-between">
                      <div>
                        <p className="text-black/70 font-semibold text-sm mb-1">BIRTHDAY!</p>
                        <h2 className="text-6xl font-black text-black tracking-tight">HAPPY</h2>
                        <h2 className="text-6xl font-black text-black tracking-tight">SWEET SEVENTEEN</h2>
                        <p className="text-black/80 mt-3 font-medium">See your year in music together</p>
                      </div>
                      <div className="w-32 h-32 bg-black/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <div className="sticky top-0">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between">
                ...
                <Heart className="w-5 h-5 text-[#1ed760] fill-[#1ed760] cursor-pointer" />
              </div>
            </div>

            <div className="space-y-3">
              <p className="text-[#b3b3b3] text-sm font-semibold">Up next</p>
              <div className="flex items-center gap-3 p-2 rounded hover:bg-[#1a1a1a] cursor-pointer transition-colors">
                <img src="https://upload.wikimedia.org/wikipedia/en/8/8b/I_love_you_3000_cover.png" alt="" className="w-10 h-10 rounded object-cover" />
                <div className="flex-1 min-w-0">
                  <p className="text-white text-sm font-medium truncate">I Love You 3000</p>
                  <p className="text-[#b3b3b3] text-xs truncate">Stephanie Poetri</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-2 rounded hover:bg-[#1a1a1a] cursor-pointer transition-colors">
                <img src="https://i.scdn.co/image/ab67616d0000b27303769726e96538c554af7c61" alt="" className="w-10 h-10 rounded object-cover" />
                <div className="flex-1 min-w-0">
                  <p className="text-white text-sm font-medium truncate">P.S I LOVE YOU</p>
                  <p className="text-[#b3b3b3] text-xs truncate">Paul Partohap</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="h-[90px] bg-black border-t border-[#282828] px-4 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-4 w-[30%] min-w-[180px]">
          ...
          <Heart className="w-4 h-4 text-[#1ed760] fill-[#1ed760] cursor-pointer shrink-0" />
        </div>

        {/* Player Controls */}
        <div className="flex flex-col items-center gap-2 w-[40%] max-w-[722px]">
          <div className="flex items-center gap-6">
            <Shuffle className="w-4 h-4 text-[#b3b3b3] hover:text-white cursor-pointer transition-colors" />
            <SkipBack className="w-5 h-5 text-[#b3b3b3] hover:text-white cursor-pointer fill-current transition-colors" />
            <button
              onClick={togglePlay}
            ...
            <SkipForward className="w-5 h-5 text-[#b3b3b3] hover:text-white cursor-pointer fill-current transition-colors" />
            <Repeat className="w-4 h-4 text-[#b3b3b3] hover:text-white cursor-pointer transition-colors" />
          </div>
          <div className="flex items-center gap-2 w-full">
            <span className="text-[#b3b3b3] text-xs w-10 text-right">1:45</span>
            <div className="flex-1 h-1 bg-[#4d4d4d] rounded-full group cursor-pointer">
              <div className="h-full bg-white rounded-full group-hover:bg-[#1ed760] transition-colors relative" style={{ width: `${currentSong.progress}%` }}>
                <div className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-3 bg-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
            </div>
            <span className="text-[#b3b3b3] text-xs w-10">3:52</span>
          </div>
        </div>

        {/* Volume */}
        <div className="flex items-center justify-end gap-3 w-[30%] min-w-[180px]">
          <Volume2 className="w-4 h-4 text-[#b3b3b3] hover:text-white cursor-pointer transition-colors" />
          <div className="w-24 h-1 bg-[#4d4d4d] rounded-full group cursor-pointer">
            <div className="h-full bg-white rounded-full group-hover:bg-[#1ed760] transition-colors w-[70%]"></div>
          </div>
        </div>
      </div>
    </div>
